...
fn start() -> ! {
    ...
    let led_1_pin = port0.p0_13.into_push_pull_output(hal::gpio::Level::High).degrade();
    let led_2_pin = port0.p0_14.into_push_pull_output(hal::gpio::Level::High).degrade();
    let led_3_pin = port0.p0_15.into_push_pull_output(hal::gpio::Level::High).degrade();
    let led_4_pin = port0.p0_16.into_push_pull_output(hal::gpio::Level::High).degrade();
