...
- [Interrupts](./4_interrupts/0_summary.md)
    ...
    - [Interrupts with `cortex-m-rt`](./4_interrupts/3_cortex_m_rt/0_cortex_m_rt.md)
        ...
        - [Main loop](./4_interrupts/3_cortex_m_rt/8_main_loop.md)
        - [Demo](./4_interrupts/3_cortex_m_rt/9_demo.md)
    - [What to take into account](./4_interrupts/4_usage/1_implications.md)
    - [Interrupts with RTIC](./4_interrupts/5_rtic/0_rtic.md)
        - [RTIC app](./4_interrupts/5_rtic/1_app.md)
        - [App outline](./4_interrupts/5_rtic/2_rtic_outline.md)
        - [`#[app]`](./4_interrupts/5_rtic/3_rtic_app_attr.md)
        - [Resources](./4_interrupts/5_rtic/4_rtic_resources.md)
        - [`#[init]`](./4_interrupts/5_rtic/5_rtic_init.md)
        - [`#[idle]`](./4_interrupts/5_rtic/6_rtic_idle.md)
        - [Software tasks](./4_interrupts/5_rtic/7_rtic_software_tasks.md)
        - [Hardware tasks](./4_interrupts/5_rtic/8_rtic_hardware_tasks.md)
        - [Task scheduling](./4_interrupts/5_rtic/9_rtic_scheduling.md)
        - [Task scheduling continued](./4_interrupts/5_rtic/10_rtic_scheduling_continued.md)
        - [Demo](./4_interrupts/5_rtic/11_demo.md)
    - [Questions](./4_interrupts/questions.md)
    - [Assignment](./4_interrupts/assignment.md)
